...
-- RenameIndex
ALTER INDEX IF EXISTS "StudentBehaviourRecord_parentNotificationRequired_parentNotifie" RENAME TO "StudentBehaviourRecord_parentNotificationRequired_parentNot_idx";
